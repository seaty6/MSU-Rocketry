...
//pins:     biggger # is CLK on amp and DAT is smaller # on amp
...
const int HX711_dout_3 = 2; //mcu > HX711 no 3 dout pin
const int HX711_sck_3 = 3; //mcu > HX711 no 3 sck pin
...
const int calVal_eepromAdress_3 = 4; // eeprom adress for calibration value load cell 3 (4 bytes)
unsigned long t = 0;
...
void setup() {
  ...
  calibrationValue_1 = 320167.78; // uncomment this if you want to set this value in the sketch
  calibrationValue_2 = 350801.15; // uncomment this if you want to set this value in the sketch
  calibrationValue_3 = 45391.20; // uncomment this if you want to set this value in the sketch
...
void loop() {
  ...
  if ((newDataReady)) {
    if (millis() > t + serialPrintInterval) {
      ...
      //Serial.println(c);
      Serial.print("Combined Load Cell Weight: ");
      Serial.println(d);
      newDataReady = 0;
      t = millis();
    }
